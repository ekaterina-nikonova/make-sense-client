...
export default (() =>
  <svg width="37" height="32" viewBox="0 0 37 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M16.5 12C16.5 11.7239 16.7239 11.5 17 11.5H36C36.2761 11.5 36.5 11.7239 36.5 12V17.5H16.5V12Z" fill="#9FA0B3" stroke="#46454C"/>
    <circle cx="20.5" cy="14.5" r="1.5" fill="#FBFBFB" stroke="#46454C"/>
    <circle cx="25.5" cy="14.5" r="1.5" fill="#FBFBFB" stroke="#46454C"/>
    <path d="M16.5 31C16.5 31.2761 16.7239 31.5 17 31.5H36C36.2761 31.5 36.5 31.2761 36.5 31V19.5H16.5V31Z" fill="#9FA0B3" stroke="#46454C"/>
